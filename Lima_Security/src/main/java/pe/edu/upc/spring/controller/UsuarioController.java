...
public class UsuarioController {
	...
	public String registrar(@ModelAttribute Usuario objUser, BindingResult binRes, Model model) throws ParseException {
		if (binRes.hasErrors())
			return "usuario";
		else {
	...
	public String modificar(@PathVariable int id, Model model, RedirectAttributes objRedir) throws ParseException {
		Optional<Usuario> objUser = uService.listarId(id);
		if(objUser == null) {
			objRedir.addFlashAttribute("mensaje", "Ocurrio un error");
			return "redirect:/usuario/listar";
		}
		else {
			model.addAttribute("usuario", objUser);
			return "usuario";
		}
	}
