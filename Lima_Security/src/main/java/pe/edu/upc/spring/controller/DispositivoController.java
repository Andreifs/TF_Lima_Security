...
public class DispositivoController {
	...
	@RequestMapping("/")
	public String irPaginaListadoDispositivos(Map<String, Object> model) {
		model.put("listaDispositivos", dService.listar());
	...
	public String modificar(@PathVariable int id, Model model, RedirectAttributes objRedir) throws ParseException {
		Optional<Dispositivo> objDisp = dService.listarId(id);
		if(objDisp == null) {
			objRedir.addFlashAttribute("mensaje", "Ocurrio un error");
			return "redirect:/dispositivo/listar";
		}
		else {
			model.addAttribute("dispositivo", objDisp);
			return "dispositivo";
		}
	}
